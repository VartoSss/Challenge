...
public class ShapeTest
{
    ...
    [TestCase(ShapeData.Equilateraltriangle, "equilateraltriangle")]
    [TestCase(ShapeData.Circle, "circle")]
    [TestCase(ShapeData.Circle2, "circle")]
    public static void ShapeTests(string task, string expectedResult)
    {
        Assert.AreEqual(expectedResult, Shape.ShapeSolver(task));
    }
}
